...
export default function HomePage() {
  ...
  return (
    ...
    >
      <Head>
        <title>FLO Explorer — Blockchain Explorer</title>
        <meta
          name="description"
          content="Explore the FLO blockchain. Search for transactions, addresses, blocks, and monitor network health."
        />
        <meta property="og:title" content="FLO Explorer" />
        <meta property="og:description" content="Explore the FLO blockchain." />
      </Head>
